...
pub fn generate(
    ...
    blob_scale: f32,
    smooth_passes: u32,
    spawn_pos: crate::snake::Position,
    spawn_clearance: i32,
) -> Vec<bool> {
...
// Even after many passes, isolated 1×1 cells remain because they don't reach
...
// No isolated cells exist because the field is continuous.
//
// Pipeline:
...
/// Terrain generation using fBm cluster noise.
pub struct TerrainPlugin;

impl Plugin for TerrainPlugin {
    fn build(&self, _app: &mut App) {
        // Terrain generation is called at startup - no systems needed
        // The generate() function is exported for SimulationPlugin to use
    }
}
